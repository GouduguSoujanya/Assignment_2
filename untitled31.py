...
Original file is located at
    https://colab.research.google.com/drive/1DbZMgpwaN_WhqTICTl3PXfsGefpYFAVT
"""
...
def line_intersect(n1,c1,n2,c2):
  ...
  p = np.array([c1,c2])
   #Intersection
  P=np.linalg.inv(N)@p
#  P=np.linalg.inv(N.T)@p  return P
#Radius and centre of the circumcircle
#of triangle ABCdef ccircle(A,B,C):
  p = np.zeros(2)
  n1 = dir_vec(B,A)
...
#of triangle ABCdef icentre(A,B,C,k1,k2):
  p = np.zeros(2)
  t = norm_vec(B,C)
...
#return z
dvec = np.array([-1,1])
 #Orthogonal matrixomat = np.array([[0,1],[-1,0]])
